...
const CalendarView = () => {
  const API_URL = process.env.REACT_APP_API_URL || "http://localhost:5000/api"; // use env variable
  ...
  const handleSaveEvent = () => {
    ...
    axios
      .post(`${API_URL}/calendar`, eventToSend)
      .then((response) => {
          ...
          <div className="add-event-modal-overlay" onClick={closeAddEventModal}>
            ...
            >
              ...
              <div className="add-event-modal-buttons">
                <button
                  className="add-event-cancel-btn"
